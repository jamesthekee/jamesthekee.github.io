...
Here's a list of things I love, made by other people, that you might not know about. If you're interested in the same things as me, perhaps you'll find something interesting in here.
...
- [OKCupid blog (archived)](https://gwern.net/doc/psychology/okcupid/autoeroticisminamerica.html)
- [What ARGs Can Teach Us About QAnon](https://mssv.net/2020/08/02/what-args-can-teach-us-about-qanon/)
- [Internet Census (2012)](https://census2012.sourceforge.net/paper.html)

### Textbooks
- [Neural Networks and Deep Learning by Micheal Nielsen](http://neuralnetworksanddeeplearning.com/)
- [Speech and language processing](https://web.stanford.edu/~jurafsky/slp3/)

###  Blogs, newsletters, people, podcasts.
