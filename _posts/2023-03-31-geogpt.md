...
1. The Worldcities database's reliability (with coordinate inaccuracies cities, and cities with little proof of their existence). 
2. Demonstrating regional bias would require more individual study and expands breadth of work and makes it harder to do look anything globally. 
